...
import org.mezoo.messenger.DispatchQueue;
...
import org.mezoo.messenger.camera.CameraInfo;
import org.mezoo.messenger.camera.CameraSession;
import org.mezoo.messenger.camera.Size;
import org.mezoo.messenger.exoplayer2.ExoPlayer;
import org.mezoo.messenger.video.MP4Builder;
import org.mezoo.messenger.video.Mp4Movie;
import org.mezoo.tgnet.ConnectionsManager;
import org.mezoo.tgnet.TLRPC;
import org.mezoo.ui.ActionBar.Theme;
import org.mezoo.ui.ChatActivity;
...
public class InstantCameraView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private Runnable timerRunnable = new Runnable() {
        ...
        public void run() {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.recordProgressChanged, duration = System.currentTimeMillis() - recordStartTime, 0.0);
    ...
    public void showCamera() {
        ...
        cameraFile = new File(FileLoader.getInstance().getDirectory(FileLoader.MEDIA_DIR_CACHE), UserConfig.lastLocalId + ".mp4");
    ...
    public void send(int state) {
        ...
        if (state == 4) {
            if (videoEditedInfo.needConvert()) {
                ...
                videoEditedInfo.estimatedSize = (long) (size * (videoEditedInfo.estimatedDuration / totalDuration));
                ...
                FileLoader.getInstance().cancelUploadFile(cameraFile.getAbsolutePath(), false);
            } else {
                videoEditedInfo.estimatedSize = size;
            }
            ...
            if (cameraThread != null) {
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.recordStopped, !cancelled && state == 3 ? 2 : 0);
                int send;
                if (cancelled) {
                    send = 0;
                } else if (state == 3) {
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        public CameraGLThread(SurfaceTexture surface, int surfaceWidth, int surfaceHeight) {
            ...
            float scale = surfaceWidth / (float) minSide;
    ...
    private class VideoRecorder implements Runnable {
        ...
        private void handleVideoFrameAvailable(long timestampNanos, Integer cameraId) {
            ...
            FileLog.e("frame time = " + currentTimestamp);
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (send == 1) {
                            ...
                            NotificationCenter.getInstance().postNotificationName(NotificationCenter.audioDidSent, videoEditedInfo, videoFile.getAbsolutePath());
                        }
