...
import org.mezoo.messenger.NativeCrashManager;
...
import org.mezoo.messenger.camera.CameraController;
...
import org.mezoo.ui.Adapters.DrawerLayoutAdapter;
import org.mezoo.ui.ActionBar.ActionBarLayout;
import org.mezoo.ui.ActionBar.BaseFragment;
import org.mezoo.ui.ActionBar.DrawerLayoutContainer;
import org.mezoo.ui.Cells.LanguageCell;
import org.mezoo.ui.Components.EmbedBottomSheet;
import org.mezoo.ui.Components.JoinGroupAlert;
import org.mezoo.ui.Components.LayoutHelper;
import org.mezoo.ui.Components.PasscodeView;
...
import org.mezoo.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("org.mezoo.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
