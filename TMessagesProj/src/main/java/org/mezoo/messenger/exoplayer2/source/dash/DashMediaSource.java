...
import org.mezoo.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
...
import org.mezoo.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import org.mezoo.messenger.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            org.mezoo.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      org.mezoo.messenger.exoplayer2.source.dash.manifest.Period period =
